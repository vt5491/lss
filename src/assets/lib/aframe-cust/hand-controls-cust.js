...
AFRAME.registerComponent('hand-controls-cust', {
  schema: {default: 'left'},

  init: function () {
    console.log(`hand-controls-cust.init: entered`);
    var self = this;
    var el = this.el;
    // Current pose.
    ...
    this.onThumbstickDown = function () {
      console.log('thumbstickDown pressed');
      window.history.back();
      self.handleButton('thumbstick', 'down'); };
    this.onMenuDown = function () {
      console.log('menudown pressed');
      window.history.back();
      self.handleButton('menu', 'down'); };
    //vt end
